...
# # Average Reynolds stresses in wake planes
...
interpXYstuff: &interpanchor
    pointlocationfunction: postproengine.interpXY4                    #Function to call to generate point locations. Function should have no arguments and return a list of points (Required)
    pointcoordsystem:   A1A2                                          #Coordinate system for point interpolation.  Options: XYZ, A1A2 (Required)
    varnames: ['velocityx_avg', 'velocityy_avg', 'velocityz_avg', 'uu_avg', 'uv_avg', 'uw_avg', 'vv_avg', 'vw_avg', 'ww_avg']     #List of variable names to extract. (Required)
    savefile: ../results/HHProfiles_300_900/XY_wake_04.csv
...
avgworkflow:
  ...
  - name: turbHH
    ...
    contourplot:
      #plotfunc: "lambda db: np.sqrt(db['velocityx_avg']**2 + db['velocityy_avg']**2)"
      #plotfunc: 'lambda db: np.sqrt(0.5*(db["uu_avg"]+db["vv_avg"]+db["ww_avg"])*2/3.0)/11.4'
      plotfunc: 'lambda db: 0.5*(db["uu_avg"]+db["vv_avg"]+db["ww_avg"])'
      title: 'NREL5MW ALM AVG TKE'
      xaxis: a1
      yaxis: a2     
      xlabel: "x/D"
      ylabel: "y/D"
      iplane: [0]
      clevels: np.linspace(0, 5, 51)
      cbar_nticks: 11
      xscalefunc: "lambda x: (x-504.0)/126.0"
      yscalefunc: "lambda y: (y-252.0)/126.0"
      figsize: [12, 4]
      savefile: '../results/images/turbineHH_AVG_ReStress_300_900.png'
      plotturbines:
      - basexyz: [0.0, 0.0, 0]
        hubheight: 0.0
        rotordiameter: 1.0
    ...
    - << : *interpanchor
      pointlocationfunction: postproengine.interpXY1
      savefile: ../results/HHProfiles_300_900/XY_wake_ReStress_01.csv
    - << : *interpanchor
      pointlocationfunction: postproengine.interpXY2
      savefile: ../results/HHProfiles_300_900/XY_wake_ReStress_02.csv
    - << : *interpanchor
      pointlocationfunction: postproengine.interpXY3
      savefile: ../results/HHProfiles_300_900/XY_wake_ReStress_03.csv
    - << : *interpanchor
      pointlocationfunction: postproengine.interpXY4
      savefile: ../results/HHProfiles_300_900/XY_wake_ReStress_04.csv
    - << : *interpanchor
      pointlocationfunction: postproengine.interpXY5
      savefile: ../results/HHProfiles_300_900/XY_wake_ReStress_05.csv
    - << : *interpanchor
      pointlocationfunction: postproengine.interpXY6
      savefile: ../results/HHProfiles_300_900/XY_wake_ReStress_06.csv
    - << : *interpanchor
      pointlocationfunction: postproengine.interpXY7
      savefile: ../results/HHProfiles_300_900/XY_wake_ReStress_07.csv
    - << : *interpanchor
      pointlocationfunction: postproengine.interpXY8
      savefile: ../results/HHProfiles_300_900/XY_wake_ReStress_08.csv
    - << : *interpanchor
      pointlocationfunction: postproengine.interpXY9
      savefile: ../results/HHProfiles_300_900/XY_wake_ReStress_09.csv
  ...
  - name: turbSW
    ...
    contourplot:
      ...
      yscalefunc: "lambda y: (y-90.0)/126.0"
      figsize: [12, 3]
      savefile: '../results/images/turbineSW_AVG_ReStress__300_900.png'
      plotturbines:
      - basexyz: [0.0, 0.0, 0]
        hubheight: 0.0
        rotordiameter: 1.0
    ...
    - << : *interpanchor
      pointlocationfunction: postproengine.interpXZ1
      savefile: ../results/XZProfiles_300_900/XZ_wake_ReStress_01.csv
    - << : *interpanchor
      pointlocationfunction: postproengine.interpXZ2
      savefile: ../results/XZProfiles_300_900/XZ_wake_ReStress_02.csv
    - << : *interpanchor
      pointlocationfunction: postproengine.interpXZ3
      savefile: ../results/XZProfiles_300_900/XZ_wake_ReStress_03.csv
    - << : *interpanchor
      pointlocationfunction: postproengine.interpXZ4
      savefile: ../results/XZProfiles_300_900/XZ_wake_ReStress_04.csv
    - << : *interpanchor
      pointlocationfunction: postproengine.interpXZ5
      savefile: ../results/XZProfiles_300_900/XZ_wake_ReStress_05.csv
    - << : *interpanchor
      pointlocationfunction: postproengine.interpXZ6
      savefile: ../results/XZProfiles_300_900/XZ_wake_ReStress_06.csv
    - << : *interpanchor
      pointlocationfunction: postproengine.interpXZ7
      savefile: ../results/XZProfiles_300_900/XZ_wake_ReStress_07.csv
    - << : *interpanchor
      pointlocationfunction: postproengine.interpXZ8
      savefile: ../results/XZProfiles_300_900/XZ_wake_ReStress_08.csv
    - << : *interpanchor
      pointlocationfunction: postproengine.interpXZ9
      savefile: ../results/XZProfiles_300_900/XZ_wake_ReStress_09.csv
"""
f = io.StringIO(stringReplaceDict(yamlstring, {'RUNDIR':RUNDIR, 'RESULTSDIR':RESULTSDIR}))
yamldict = Loader(f, **loaderkwargs)
