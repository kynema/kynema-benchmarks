...
The input files for this case are located in the [input_files](https://github.com/Kynema/kynema-benchmarks/tree/main/kynema-sgf/atmospheric_boundary_layer/neutral/input_files) directory. Several of the main input parameters for this case are summarized below: 
...
Statistics and results from the ABL are calculated using the scripts and notebooks in the [postprocessing](https://github.com/Kynema/kynema-benchmarks/tree/main/kynema-sgf/atmospheric_boundary_layer/neutral/postprocessing) directory, and are saved to the [results](https://github.com/Kynema/kynema-benchmarks/tree/main/kynema-sgf/atmospheric_boundary_layer/neutral/results) directory. 
